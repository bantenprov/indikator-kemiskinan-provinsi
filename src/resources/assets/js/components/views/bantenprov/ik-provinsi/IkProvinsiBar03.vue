...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/ik-provinsi/ik-provinsi-030.json').then(response => {
      ...
      this.bar.title.text = res[0].xAxis.category + ' ' + res[0].xAxis.yyyy ;
      ...
      setInterval(() => {
        ...
        this.bar.title.text = res[i].xAxis.category + ' ' + res[i].xAxis.yyyy  ;
