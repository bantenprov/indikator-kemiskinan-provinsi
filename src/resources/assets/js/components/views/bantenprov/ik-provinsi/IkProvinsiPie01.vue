...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/ik-provinsi/ik-provinsi-pie-010.json').then(response => {
      ...
      this.pie.title.text =  res[0].xAxis.category + ' ' + res[0].xAxis.name  ;
      ...
      setInterval(() => {
        ...
        this.pie.title.text = res[i].xAxis.category + ' ' +    res[i].xAxis.name ;
