...
export default {
  ...
  mounted: function () {
    axios.get('/json/bantenprov/ik-provinsi/ik-provinsi-pie-020.json').then(response => {
      ...
      this.pie.title.text =  res[0].xAxis.category +' Tahun ' + res[0].xAxis.yyyy  ;
      ...
      setInterval(() => {
        ...
        this.pie.title.text =  res[i].xAxis.category + ' Tahun ' + res[i].xAxis.yyyy   ;
