          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <ik-provinsi-bar-03></ik-provinsi-bar-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
        ...
        <div class="card card-media text-white bg-success">
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <ik-provinsi-pie-03></ik-provinsi-pie-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Indikator Kemiskinan Provinsi Berdasarkan Wilayah
            </div>
            <div class="card-body">
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-bar-chart" aria-hidden="true"></i>
            Indikator Kemiskinan Provinsi Berdasarkan Tahun
          </div>
          <div class="card-body">
            <ik-provinsi-bar-02></ik-provinsi-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <ik-provinsi-pie-02></ik-provinsi-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
